...
namespace svc
{
	...
	public:
		Service(
			const archproto::IProtocolData::service_id_t id,
		...
		archproto::IProtocolData::service_id_t get_id() const;
		...
		ServiceInstance* get_instance(
			const archproto::IProtocolData::service_inst_id_t& id) const;
		ServiceInstance* get_instance_random(archproto::IProtocolData::service_inst_id_t& id);


	private:
		archproto::IProtocolData::service_id_t	_id;
		std::string			_name;
		std::string			_path;
		std::string			_workingdir;
		std::string			_assembly;
		std::unordered_map<
			archproto::IProtocolData::service_inst_id_t,
			std::unique_ptr<ServiceInstance>>	_insts;
		std::vector<
			archproto::IProtocolData::service_inst_id_t> _inst_ids;
